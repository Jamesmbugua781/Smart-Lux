...
// TODO: Replace these approximate offset coordinates with real coordinates for each building, obtained from Google Maps (right-click the building -> Copy coordinates).
export const campusLocations: CampusLocation[] = [
  { id: 'library', name: 'Central Library', category: 'Academic Hub', description: 'Campus library for research support and study access.', badge: 'Library', area: 'North Quadrant', locationType: 'library', mapPosition: { left: '18%', top: '18%' }, coordinates: { lat: -0.3976875, lng: 36.9611875 }, externalUrl: 'https://www.dkut.ac.ke/library/#gsc.tab=0' },
  { id: 'computer-science', name: 'School of Computer Science', category: 'Academic Department', description: 'Department location for computing and digital studies.', badge: 'School', area: 'Innovation District', locationType: 'school', mapPosition: { left: '65%', top: '28%' }, coordinates: { lat: -0.3975375, lng: 36.9610156 }, buildingId: 'admin-academic-block', externalUrl: 'https://csit.dkut.ac.ke/' },
  { id: 'student-center', name: 'Student Services Center', category: 'Support Office', description: 'Student support services and general assistance point.', badge: 'Support', area: 'Main Campus', locationType: 'support', mapPosition: { left: '52%', top: '42%' }, coordinates: { lat: -0.3927875, lng: 36.9590469 }, externalUrl: 'https://studentwelfare.dkut.ac.ke/' },
  { id: 'registry', name: 'Registry Office', category: 'Administration', description: 'Office for records, admission, and student administration.', badge: 'Registry', area: 'Administration Block', locationType: 'registry', mapPosition: { left: '25%', top: '62%' }, coordinates: { lat: -0.3975375, lng: 36.9610156 }, buildingId: 'admin-academic-block', externalUrl: 'https://www.dkut.ac.ke/index.php/admissions-and-records' },
  { id: 'ict', name: 'ICT Help Desk', category: 'Technology', description: 'Digital access assistance and campus connectivity support.', badge: 'ICT', area: 'Tech Plaza', locationType: 'ict', mapPosition: { left: '74%', top: '64%' }, coordinates: { lat: -0.3975375, lng: 36.9610156 }, buildingId: 'admin-academic-block', externalUrl: 'https://helpdesk.dkut.ac.ke/' },
  { id: 'engineering', name: 'Engineering Faculty', category: 'Academic Department', description: 'Faculty building for engineering and applied sciences.', badge: 'Faculty', area: 'Science Campus', locationType: 'school', mapPosition: { left: '42%', top: '76%' }, coordinates: { lat: -0.3988625, lng: 36.9628281 }, externalUrl: 'https://soe.dkut.ac.ke/' },
]
